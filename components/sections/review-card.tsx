...
export function ReviewCard({ review }: ReviewCardProps) {
  return (
    <div className="group relative flex flex-col h-full w-full rounded-2xl border border-[#e5e0db] bg-white px-6 pt-4 pb-6 md:px-8 md:pt-5 md:pb-8 shadow-card hover:shadow-card-hover transition-all duration-500 hover:border-[#bea692]/30">
      ...
      <div className="h-[120px] md:h-[130px] pt-6 border-t border-[#e5e0db] relative flex-shrink-0">
