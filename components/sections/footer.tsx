      ...
      <Container>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 py-12">
          <div className="space-y-2">
            <div className="text-xl font-semibold">Anna Turbina Tours</div>
          ...
          <nav className="space-y-3">
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link href="/#tours" className="hover:text-black transition-colors">
                  Туры
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/#reviews" className="hover:text-black transition-colors">
                  Отзывы
                </Link>
              </li>
            </ul>
          ...
          <div className="space-y-3">
            ...
            <div className="flex flex-col gap-2 text-sm">
              <a href="tel:+79999999999" className="flex items-center gap-2 hover:text-black transition-colors">
                <Phone className="h-4 w-4" /> +7 (999) 999-99-99
              </a>
              <a href="mailto:info@annaturbina.tours" className="flex items-center gap-2 hover:text-black transition-colors">
