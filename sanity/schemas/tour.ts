...
const tour = defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      type: 'boolean',
      description:
        'Если включено: тур не в списке на главной, страница тура недоступна. Отзывы из этого тура по-прежнему могут показываться в общем блоке отзывов на главной.',
      initialValue: false,
    }),
  ],
  preview: {
